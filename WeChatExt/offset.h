...
#define ISLOGIN					0x17741a4	//是否登录标识，0-未登录|1-已登录
...
#define RECIEVEHOOKADDR			0x398464	//接收消息
#define RECIEVEHOOKCALL			0x178D870	//接收消息

#define SENDTEXTADDR			0x36BAC0	//发送文本消息ecx参数偏移
...
#define DATABASEHOOKADDR		0x4CBD53	//数据库hook
#define DATABASERUNCALL			0x9A4DD0	//数据库执行call
